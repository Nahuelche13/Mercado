...
public partial class ProductRow : Gtk.FlowBoxChild {
...
#pragma warning restore CS0649
    ...
    private ProductRow(Gtk.Builder builder, Product product) : base(builder.GetPointer("_root"), false) {
        _product = product;
        //Build UI
    ...
    public ProductRow(Product product) : this(Builder.FromFile("product_row.ui"), product) { }
